...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	private static String getEntryName(String dirPath, File file) {
		...
		String name = filePath.substring(index + dirPaths.length());
    ...
    public static void download(HttpServletRequest request, HttpServletResponse response, String contentType, String downLoadPath,
